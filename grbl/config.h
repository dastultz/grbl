...
#define CPU_MAP_ATMEGA644P // Sanguino
...
// kfmc: invert pins I'm not interested in because they will be tested against false for activated
...
// kfmc: invert e-stop as it's NO
#define INVERT_LIMIT_PIN_MASK ((1<<Y_LIMIT_BIT))
...
// kfmc: this is critical to pendant controls working
